    ...
    return (
        ...
        >
            <div className="flex items-center gap-2 mb-4">
                <div className="w-8 h-8 rounded-full bg-verity-100 flex items-center justify-center">
                    <MessageSquare className="w-4 h-4 text-verity-600" />
                </div>
            ...
            <div className="relative">
                {/* Quote decoration */}
                <span className="absolute -top-2 -left-2 text-4xl text-verity-200 font-serif">"</span>

                <p className="text-noir-700 leading-relaxed pl-4 italic">
                    {summary}
                </p>

                <span className="absolute -bottom-4 right-0 text-4xl text-verity-200 font-serif">"</span>
            </div>
